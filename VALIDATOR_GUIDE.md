...
### 2.3 Published v7.1.7 Node Packages

For x86_64 hosts, the [published UltraNet v7.1.7 GitHub release](https://github.com/Alexand173/ultranet/releases/tag/v7.1.7) provides precompiled node binaries. Select the archive for your platform:
...
Download the [release checksum manifest](https://github.com/Alexand173/ultranet/releases/download/v7.1.7/SHA256SUMS.txt) at the same time. Verify the archive before extracting or executing it:
...
The published `v7.1.7` Windows package contains `UltraNetNode.exe`,
...
interactive configuration failures visible. The `v7.1.7` release pipeline
