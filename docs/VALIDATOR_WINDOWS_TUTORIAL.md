...
- Use a clean Windows x64 test folder and the published `UltraNetNode-windows-x64.zip` from the [v7.1.5 release](https://github.com/Alexand173/ultranet/releases/tag/v7.1.5).
...
5. Add a small lower-third only if desired: `UltraNet v7.1.5 // Windows x64`.
...
| --- | --- | --- | --- |
| `0:00–0:15` | Open `https://ultranetwork.cc/validator` or `/download` and point at the v7.1.5 Windows x64 link. | “This is the UltraNet v7.1.5 validator onboarding path. I’ll download the verified Windows x64 node, start it, and confirm that it reaches Genesis.” | Release tag `v7.1.5`, Windows x64 archive, and checksum link. |
...
- [ ] The recording is between 2 and 3 minutes and uses the real v7.1.5 Windows x64 package.
